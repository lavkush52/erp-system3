...
$dbcon =& DB(); 
$result = $dbcon->get('tbl_config')->row(); 

defined('logo')             OR define('logo', $result->logo);
defined('favicon')          OR define('favicon', $result->favicon);
defined('site_name')      OR define('site_name', $result->site_name);
defined('email')      OR define('email', $result->email);
defined('contact')      OR define('contact', $result->contact);
defined('support_mail')      OR define('support_mail', $result->support_mail);
defined('support_contact')      OR define('support_contact', $result->support_contact);
defined('site_address')      OR define('site_address', $result->site_address);
defined('site_status')      OR define('site_status', $result->site_status);